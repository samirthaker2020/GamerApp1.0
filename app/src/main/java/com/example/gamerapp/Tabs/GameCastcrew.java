 ...
 * Use the {@link GameCastcrew#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GameCastcrew extends Fragment {
TextView castcrew;
    String HTTP_URL = Constants.URL_CAST;
     ...
     * @return A new instance of fragment GameCastcrew.
     */
    // TODO: Rename and change types and number of parameters
    public static GameCastcrew newInstance(String param1, String param2) {
        GameCastcrew fragment = new GameCastcrew();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_game_castcrew, container, false);
        castcrew=(TextView) root.findViewById(R.id.cast_details);
        fetchgamedata();
...
//                            Toast.makeText(getApplicationContext(),response.toString(), Toast.LENGTH_SHORT).show();
                            ...
                            if (obj.getBoolean("error")) {
                                ...
                                castcrew.setText(String.valueOf( obj.getString("cast")));
